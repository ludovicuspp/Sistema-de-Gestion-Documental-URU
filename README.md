...
El proyecto sigue el **Proceso Unificado de Rational (RUP)**, siendo un desarrollo iterativo, incremental, centrado en la arquitectura y dirigido por casos de uso.
...
El CID gestiona actualmente los expedientes estudiantiles en formato físico, lo que conlleva riesgos de deterioro, pérdida y lentitud en las consultas. Este sistema busca:
...
3. **Optimizar** el flujo de trabajo entre Asistentes, Verificadores y Administradores.

---

## 🏗 Arquitectura del Sistema
El sistema implementa una arquitectura en capas distribuida en nodos Cliente-Servidor:
...
| **Almacenamiento** | **Híbrido** | Sistema de archivos local / Nube (según restricción RST-04). |

---

## 📂 Estructura del Monorepo
Este repositorio agrupa tanto el cliente como el servidor para facilitar la gestión de configuración.
