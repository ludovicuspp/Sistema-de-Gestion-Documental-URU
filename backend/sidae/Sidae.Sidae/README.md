...
git clone <url-del-repositorio> Sidae.Sidae
cd Sidae.Sidae
...
- **Debug:** `bin/Debug/net10.0/Sidae.Sidae.dll`
- **Release:** `bin/Release/net10.0/Sidae.Sidae.dll`
...
Desde `Sidae.Sidae/Sidae.Sidae.csproj`, la ruta relativa al proyecto compartido es:
...
Estructura esperada en disco: `backend/Sidae.Commons/` y `backend/support/Sidae.Sidae/` (hermanos bajo `backend/`).
...
3. **Referenciar** en `Sidae.Sidae.csproj`:
