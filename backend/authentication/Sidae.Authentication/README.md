...
git clone <url-del-repositorio> Sidae.Authentication
cd Sidae.Authentication
...
- **Debug:** `bin/Debug/net10.0/Sidae.Authentication.dll`
- **Release:** `bin/Release/net10.0/Sidae.Authentication.dll`
...
Desde `Sidae.Authentication/Sidae.Authentication.csproj`, la ruta relativa al proyecto compartido es:
...
Estructura esperada en disco: `backend/Sidae.Commons/` y `backend/support/Sidae.Authentication/` (hermanos bajo `backend/`).
...
3. **Referenciar** en `Sidae.Authentication.csproj`:
