...
git clone <url-del-repositorio> Sidae.Documents
cd Sidae.Documents
...
- **Debug:** `bin/Debug/net10.0/Sidae.Documents.dll`
- **Release:** `bin/Release/net10.0/Sidae.Documents.dll`
...
Desde `Sidae.Documents/Sidae.Documents.csproj`, la ruta relativa al proyecto compartido es:
...
Estructura esperada en disco: `backend/Sidae.Commons/` y `backend/documents/Sidae.Documents/` (hermanos bajo `backend/`).
...
3. **Referenciar** en `Sidae.Documents.csproj`:
