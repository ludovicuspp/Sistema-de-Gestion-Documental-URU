...
public interface IDocumentTypeService
{
    ...
    Task<Result<DocumentTypeResponse>> GetByIdAsync(Guid guidId, CancellationToken cancellationToken = default);
    ...
    Task<Result<DocumentTypeResponse>> UpdateAsync(Guid guidId, UpdateDocumentTypeRequest request, CancellationToken cancellationToken = default);
}
